  ...
  return (
    <section className="relative py-24 md:py-32 lg:py-40 px-4 bg-secondary overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <div className="inline-block bg-white border-4 border-background p-6 mb-12 rotate-1 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          <p
        ...
        <a 
          ...
          className="mt-12 inline-block bg-white border-4 border-background p-4 -rotate-1 shadow-[6px_6px_0px_0px_rgba(255,0,0,0.6)] hover:shadow-[8px_8px_0px_0px_rgba(255,0,0,0.8)] transition-all duration-200 cursor-pointer"
        >
          <p
            className="text-secondary text-lg md:text-xl font-bold uppercase"
            style={{ fontFamily: "var(--font-bebas-neue), Impact, sans-serif" }}
          >
