    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center items-center gap-2 md:gap-4 px-4 mb-12 mt-24 md:mt-32">
        ...
        <div className="flex justify-center items-center">
          <img 
            ...
            className="w-[220px] h-[220px] object-contain transition-all duration-500 rounded-[6px]"
          />
        </div>
      ...
      <div className="relative z-20 flex flex-row items-center gap-6">
        <a 
          ...
          className="inline-block bg-white border-4 border-background p-6 mb-12 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[4px] hover:translate-y-[4px] transition-all duration-200 cursor-pointer"
