    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center gap-6">
        ...
        <a 
          ...
          className="bg-secondary border-4 border-background p-3 -rotate-3 shadow-[6px_6px_0px_0px_rgba(255,0,0,0.5)] hover:shadow-[8px_8px_0px_0px_rgba(255,0,0,0.7)] transition-all duration-200 cursor-pointer"
        >
          <p className="text-background text-sm md:text-base font-bold flex items-center gap-2">
